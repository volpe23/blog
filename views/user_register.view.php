<div id="user_register_form" class="container">
    <form method="POST" action="/user_register" class="border border-gray-500 p-8 max-w-96 my-6 mx-auto rounded">
        <div class="form-control">
            ...
            <input name="username" id="username" class="form-input <?= !empty($usernameError) ? "input-error" : "" ?>" placeholder="Username">
        ...
        <div class="form-control">
            ...
            <input name="password" id="password" type="password" class="form-input <?= !empty($passwordError) ? "input-error" : "" ?>" placeholder="Password">
